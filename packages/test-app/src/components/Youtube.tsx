...
export interface YoutubeProps {
  ...
  videoID: string;
  /** Show "Watch on YouTube" impression text (default: true). */
  ytImpression?: boolean;
  /** Set the strategy for image loading (default: lazy)  */
  imageLoading?: "lazy" | "eager" | undefined;
  /** When true, uses youtube-nocookie.com domain for enhanced privacy. (default: false) */
  noCookie?: boolean;
}
 ...
 *
 * @param props - See {@link YoutubeProps}
 */
